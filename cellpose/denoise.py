...
class CellposeDenoiseModel:
    ...
    def __init__(
        ...
        Initialize the model with specified parameters.
            ...
            This method sets up the DenoiseModel and CellposeModel components
            based on the provided configuration options. It allows for GPU usage,
            selection of pretrained models, and configuration of restoration and
            channel parameters.

            Args:
                gpu: Indicates whether to use GPU for computations.
                pretrained_model: Specifies whether to load a pretrained model.
                model_type: Specifies the type of the model to use for Cellpose.
                restore_type: Sets the restoration type for the DenoiseModel, defaults to "denoise_cyto3".
                nchan: Defines the number of channels, with a default value of 2.
                chan2_restore: Indicates whether to restore the second channel.
                device: Specifies the computing device to be used (e.g., CPU or GPU).
...
class DenoiseModel:
    ...
    def __init__(
        ...
        Initializes an instance of the class.
            ...
            This constructor sets up the parameters for the model, including determining
            whether to use a GPU, loading a pretrained model, and configuring the network.

            Args:
                gpu: A flag to indicate whether to use a GPU for processing.
                pretrained_model: Either a string representing the path to a pretrained model
                                  or a boolean indicating whether to use a default pretrained model.
                nchan: The number of channels for the model.
                model_type: An optional string specifying the type of model to use.
                chan2: A flag indicating whether to load a secondary model for channel 2.
                diam_mean: The mean diameter for processing, default is 30.0.
                device: An optional parameter to specify the device on which to run the model.
...
def train(
    ...
    """
    Train a neural network for image segmentation or denoising.

        This method trains the specified neural network using the provided training data,
        labels, and various hyperparameters. It can also be configured to validate the model
        on test data and save the model checkpoints at specified frequencies.

        Args:
            net: The neural network model to be trained.
            train_data: The training images.
            train_labels: The corresponding labels for the training images.
            train_files: List of file paths for training images if train_data is not provided.
            test_data: The test images for validation during training.
            test_labels: The corresponding labels for the test images.
            test_files: List of file paths for test images if test_data is not provided.
            train_probs: The probabilities for sampling training images.
            test_probs: The probabilities for sampling test images.
            lam: List of regularization parameters.
            scale_range: The scale range used in data augmentation.
            seg_model_type: The segmentation model type to use.
            save_path: Path to save model checkpoints.
            save_every: Frequency of saving model checkpoints.
            save_each: Whether to save a model after each epoch.
            poisson: Noise level for Poisson noise.
            beta: Parameter controlling noise intensity.
            blur: Amount of Gaussian blur to apply.
            gblur: Generalized blur parameter.
            iso: Whether to use isotropic or anisotropic processing.
            uniform_blur: Whether to apply uniform blur.
            downsample: Downsampling factor for input images.
            ds_max: Maximum downsampling level.
            learning_rate: Initial learning rate for training.
            n_epochs: Total number of training epochs.
            weight_decay: Weight decay for the optimizer.
            batch_size: Number of images in each batch during training.
            nimg_per_epoch: Number of images to use in each training epoch.
            nimg_test_per_epoch: Number of images to use in each test epoch.
            model_name: Custom name for the saved model.

        Returns:
            A tuple containing the path to the saved model, a list of training losses, and a list of test losses.
    """
